...
class Details extends React.Component
{
    ...
    componentDidMount()
    {
        ...
        axios({
            method : 'GET',
            url : `https://backend-qghm.onrender.com/api/resturantbyid/${resturantId}`,
    ...
    handleModal = (state,value) =>
    {
        ...
        axios(
            {
                method : 'GET',
                url:`https://backend-qghm.onrender.com/api/getMenu/${resturantId}`,
                headers:{ 'Content-Type' : 'application/json' }
            }
        ).then(response => {
    ...
    buildForm = ({ action, params }) => {
      ...
      getData = (data) => {
        return fetch(`https://backend-qghm.onrender.com/api/payment`, {
            method: "POST",
            headers: {
